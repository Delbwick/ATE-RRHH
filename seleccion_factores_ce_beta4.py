...
st.set_page_config(page_title="RRHH del Norte-Selecciona los factores de complemento Específico", page_icon="🧐")
st.title("¡Bienvenido a APP VALORACIONES DE PUESTOS DE TRABAJO 👷")
st.header("Continuamos con la Seleccion de Factores de Complemento Específico - beta4")
...
st.write("# Seleccion Factores de Complemento Especifico por proyecto")
